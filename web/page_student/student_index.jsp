...
<head>
    ...
    <link rel="stylesheet" href="../lid/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "api/init-student.json",    // 初始化接口
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                ...
                window.location = 'page/login-student.html';
            });
        });
    });
</script>
